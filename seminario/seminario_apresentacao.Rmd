...
- PCC-GARCH fitted using data from January 2002 to February 2009. 

## Simulation 

- Simulate 5000 log-percentage change of economic variables for 60-months using the the pair copula-GARCH(1,1) model.
