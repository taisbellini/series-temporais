...
- (Explanation of feedforward neural network with 3 layers)
...
## Economic Factor-Based Predictive Model (EFPM) {.allowframebreaks}
...
- Learning process: Gradient descent to iteractively update $w_{jk}$ 
...
- table of macroeconomic factors
