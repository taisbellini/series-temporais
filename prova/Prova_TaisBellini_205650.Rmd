...
Para mostrar que \label{eq:varmv} é equivalente ao estimador de mínimos quadrados ordinários (OLS) da linha j, vamos expandir o último termo, somando e subtraindo $\hat{\Pi}^\intercal \mathbf{x_t}$ e determinando $\hat{\epsilon_t} = y_t - \hat{\Pi}^\intercal \mathbf{x_t}$ como o vetor de resíduos amostrais da observação $t$ de uma regressão OLS de $y_{jt}$ em $x_t$, $j = 1, ..., p$:
