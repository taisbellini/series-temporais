...
Fazendo a derivação em relação a $\Pi$ de \ref{eq:logvar} para obter o estimador de MV dos parâmetros do modelo, obtemos o seguinte resultado:
$$
...
plot(x,y, main = "Yt grau=1 e h = 1")
lines(m1$x, m1$y, col = "red")
m2 = locpoly(x, y, bandwidth = 100)
plot(x,y, main = "Yt grau=1 e h = 100")
lines(m2$x, m2$y, col = "blue")
m3 = lm(y ~ x)
plot(x,y, main = "Yt regressão linear")
abline(m3, col = "orange")
m4 = locpoly(x, y, bandwidth = 0.1)
plot(x,y, main ="Yt com degree=1 e h = 0.1")
...
plot(x,y, main = "Yt com h por CV")
lines(m1$x, m1$y, col = "purple")

m2 = locpoly(x,y, bandwidth = hplug)
plot(x,y, main = "Yt com h por plug-in")
