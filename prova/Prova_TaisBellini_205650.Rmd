...
Observa-se que o método de cross-validation escolheu o $\lambda = 0.1$ e, em comparação com o $\lambda = 0.5$ zerou menos coeficientes, o que é esperado. As variáveis que indicam ocorrência de caminhão parado, atropelamento e acidentes com carga foram removidas do modelo. Con exceção de atropelamento, as outras variáveis possuem poucas ocorrências no banco de dados, sendo coerente a remoção delas.
