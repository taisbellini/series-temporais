...
knitr::include_graphics(c('comp_piqr_a0_noreal.png', 'comp_piqr_a1_noreal.png', 'comp_piqr_t1_noreal.png'))
```
...
knitr::include_graphics('mse_lag1.png')
```
...
knitr::include_graphics('mse_lag2.png')
```
