...
To test the proposed approach, we used Monte Carlo simulations with 200 replications using the simulation method described above. The global estimation function was evaluated with 3 different datasets:
...
We analyzed two aspects: the coefficients estimation and the chosen variables by the variable selection. We compared the results with a regular quantile regression approach and the global estimation function _piqr_ without weights implemented in @Sottile2020.
