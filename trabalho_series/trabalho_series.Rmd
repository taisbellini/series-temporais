...
\label{eq:adl}
\end{equation}
<!--- ?? um comentário sobre LaTeX: para obter a diagramação correta, não se separa com linha em branco a equação do restante do parágrafo (a não ser que após a equação tu desejes iniciar um novo parágrafo). Tomei a liberdade de corrigir isso no restante do documento. --->
...
>>>>>>> 82cb045028cd8732ca1369a475508b3c426d9081
$$
