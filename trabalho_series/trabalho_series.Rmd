...
where $\rho_\tau(v) = v(\tau - \mathbb{I}_{[v<0]})$. @Frumento2016 suggested a different approach: modeling the coefficient functions $\beta(\tau)$ as parametric functions of the order of the quantile. Consider $\varphi$ a vector of model parameters, then we can describe the quantile function as: 
